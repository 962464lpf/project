  ...
  <div class="app-container" style="padding-top: 30px;">
    <el-form ref="form" :model="form" :rules="rules" label-width="130px" style="padding-right: 100px;">
      ...
      <template v-if="pageType !== 'dc'">
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="整改措施" prop="rectMeasures">
              <el-input v-model="form.rectMeasures" type="textarea" placeholder="请输入整改措施" rows="4" maxlength="300" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="目前进展情况" prop="currentProgress">
              <el-input v-model="form.currentProgress" type="textarea" placeholder="请输入目前进展情况" rows="4" maxlength="300" />
            </el-form-item>
          </el-col>
        </el-row>
      </template>
