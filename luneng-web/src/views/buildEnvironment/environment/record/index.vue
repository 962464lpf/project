<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="el-icon-plus"
          @click="handleAdd"
          v-hasPermi="['hb:hbRectRecord:wt:add']"
        >新增记录</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="200">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['hb:hbRectRecord:wt:edit']"
          >修改</el-button>
          <el-button
            v-if="scope.row.completeStatus == 0 && fileStatus != '1'"
            ...
            v-hasPermi="['hb:hbRectRecord:wt:remove']"
          >删除</el-button>
          <el-button

            type="text"
            @click="handleDetail(scope.row)"
            v-hasPermi="['hb:hbRectRecord:wt:query']"
          >详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <pagination
      ...
      @pagination="getList"
    />
    <div v-hasPermi="['hb:hbRectRecord:wt:clzt']" id="managementClzt"></div>
  </div>
</template>
