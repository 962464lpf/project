<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="el-icon-plus"
          @click="handleAdd"
          v-hasPermi="['hb:hbRectRecord:zc:add']"
        >新增记录</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
    ...
    <el-table ref="table" v-loading="loading" :data="hbRectRecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="经办人" align="center" prop="agent" min-width="100"  />
      <el-table-column label="记录时间" align="center" prop="recordDate" min-width="120" >
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.recordDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="地点" align="center" prop="happenAddr" min-width="140"  />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="200">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['hb:hbRectRecord:zc:edit']"
          >修改</el-button>
          <el-button
            v-if="scope.row.completeStatus == 0 && fileStatus != '1'"
            type="text"
            ...
            v-hasPermi="['hb:hbRectRecord:zc:remove']"
          >删除</el-button>
          <el-button
            type="text"
            @click="handleDetail(scope.row)"
            v-hasPermi="['hb:hbRectRecord:zc:query']"
          >详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <div v-hasPermi="['hb:hbRectRecord:zc:clzt']" id="managementClzt"></div>
  </div>
</template>
